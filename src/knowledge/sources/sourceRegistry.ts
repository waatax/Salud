...
export const CANONICAL_SOURCE_REGISTRY: Record<string, SourceItemV2> = {
  ...
  'SRC-AWGS-2019-SARCOPENIA': {
    id: 'SRC-AWGS-2019-SARCOPENIA',
    ...
    year: 2020,
    grade: 'A',
    canonical_url: 'https://www.jamda.com/article/S1525-8610(19)30866-9/fulltext',
    version: 'AWGS-2019-Consensus',
    retrieved_date: '2026-09-23',
    jurisdiction: 'global',
    provenance_level: 'expert-consensus',
    status: 'active',
    description_zh: '亞洲肌少症工作小組共識：以握力（男 <28 kg, 女 <18 kg）或 5 次起立坐下測試作為初篩紅線。',
  },

  'SRC-AASM-2020-OSA': {
    id: 'SRC-AASM-2020-OSA',
    title: 'Diagnosis and Management of Obstructive Sleep Apnea: Clinical Review and Practice Consensus',
    publisher: 'JAMA / American Academy of Sleep Medicine',
    year: 2020,
    grade: 'A',
    canonical_url: 'https://jamanetwork.com/journals/jama/article-abstract/2764301',
    version: 'AASM-JAMA-OSA-2020',
    retrieved_date: '2026-09-23',
    jurisdiction: 'global',
    provenance_level: 'verified-primary',
    status: 'active',
    description_zh: '睡眠呼吸中止症診斷分級（AHI 5–15 輕度、15–30 中度、≥30 重度）與難治型高血壓因果關聯。',
  },

  'SRC-EASL-MASLD-2023': {
    id: 'SRC-EASL-MASLD-2023',
    title: 'A Multisociety Delphi Consensus Statement on New Fatty Liver Disease Nomenclature (MASLD)',
    publisher: 'Journal of Hepatology',
    year: 2023,
    grade: 'A',
    canonical_url: 'https://www.journal-of-hepatology.eu/article/S0168-8278(23)00418-3/fulltext',
    version: 'MASLD-Delphi-2023',
    retrieved_date: '2026-09-23',
    jurisdiction: 'global',
    provenance_level: 'expert-consensus',
    status: 'active',
    description_zh: '代謝功能障礙相關脂肪性肝病 (MASLD) 新共識定義：脂肪肝合併至少一項心血管代謝風險因子。',
  },

  'SRC-ACR-GOUT-2020': {
    id: 'SRC-ACR-GOUT-2020',
    title: '2020 American College of Rheumatology Guideline for the Management of Gout',
    publisher: 'Arthritis & Rheumatology',
    year: 2020,
    grade: 'A',
    canonical_url: 'https://acrjournals.onlinelibrary.wiley.com/doi/10.1002/art.41247',
    version: 'ACR-Gout-2020',
    retrieved_date: '2026-09-23',
    jurisdiction: 'us',
    provenance_level: 'verified-primary',
    status: 'active',
    description_zh: '美國風濕病學會痛風指引：降尿酸治療目標 <6.0 mg/dL（嚴重痛風石 <5.0 mg/dL）。',
  },
};
