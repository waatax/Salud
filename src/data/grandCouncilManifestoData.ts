...
export const GRAND_COUNCIL_MANIFESTO = {
  version: 'v1.2.0 Unified Biophilic Green Palette & Expert Zone Release',
  release_date: '2026-09-15',
  title_zh: 'Salud v1.2.0 全人健康長壽大憲章 (Salud v1.2.0 Unified Health & Longevity Charter)',
  title_en: 'Salud v1.2.0 Unified Health & Longevity Charter',
  proclamation_zh:
