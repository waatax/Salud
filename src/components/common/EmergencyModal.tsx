  ...
  return (
    ...
    >
      <div className="space-y-4 font-sans text-xs">
        ...
        <div className="p-4 rounded-xl border border-red-500/60 bg-red-950/40 space-y-2 text-red-100">
          ...
          <div className="p-2.5 rounded-lg bg-red-600/40 border border-red-400/50 font-bold text-white flex items-center gap-2">
        ...
        {/* Heat Stroke */}
        <div className="p-4 rounded-xl border border-orange-500/60 bg-orange-950/30 space-y-2 text-orange-100">
        ...
        <div className="p-4 rounded-xl border border-salud-amber/60 bg-salud-amber-950/30 space-y-2 text-amber-100">
          <div className="flex items-center gap-2 text-salud-amber-300 font-bold text-sm">
            <HeartCrack className="w-5 h-5 text-salud-amber-400" />
        ...
        <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-between text-slate-300 font-mono">
          <span>台灣緊急救護專線：</span>
