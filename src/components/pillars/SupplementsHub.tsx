...
export const SupplementsHub: React.FC = () => {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto font-sans text-xs pb-16">
      {/* Hero Header */}
      <div className="p-6 sm:p-8 rounded-3xl border border-nature-green-200/90 dark:border-nature-green-800/40 bg-gradient-to-br from-nature-green-100/70 via-white to-nature-sky-50/40 dark:from-nature-green-950/40 dark:via-salud-dark-card/60 dark:to-slate-950 relative overflow-hidden shadow-sm transition-colors">
        <div className="relative space-y-3 max-w-2xl">
          <span className="px-2.5 py-1 rounded-full font-mono text-xs font-bold border border-nature-green-300/80 bg-nature-green-100/80 text-nature-green-800 dark:border-nature-green-700/60 dark:bg-nature-green-950/60 dark:text-nature-green-300">
      ...
      <section className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3">
