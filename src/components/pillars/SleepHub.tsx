...
export const SleepHub: React.FC = () => {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto font-sans text-xs pb-16">
      {/* Hero Header */}
      <div className="p-6 sm:p-8 rounded-3xl border border-purple-500/40 bg-gradient-to-br from-purple-100/70 via-salud-light-card/80 to-slate-100 dark:from-purple-950/40 dark:via-salud-dark-card/60 dark:to-slate-950 relative overflow-hidden">
        <div className="relative space-y-3 max-w-2xl">
          <span className="px-2.5 py-1 rounded-full font-mono text-xs font-bold border border-purple-500/40 bg-purple-500/20 text-purple-700 dark:text-purple-300">
      ...
      <section className="space-y-3">
        <div className="border-b border-salud-light-border/60 dark:border-salud-dark-border/60 pb-2 flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {SLEEP_STAGES.map((st) => (
            <div
              key={st.stage}
              className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 space-y-2"
            >
              <div className="flex items-center justify-between">
                <span className="font-mono text-xs font-bold text-purple-400">
                  {st.stage.replace('_', ' ')}
                </span>
                <span className="px-1.5 py-0.5 rounded bg-purple-950/60 text-purple-300 font-mono text-[10px]">
                  {st.pct_of_night}
                </span>
              </div>
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-slate-800/60 text-[10px] text-slate-500 font-mono">
