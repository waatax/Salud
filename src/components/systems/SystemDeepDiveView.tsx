...
import { SystemDeepDive, DeepCondition, DeepKnowledgePoint, DeepProtocol } from '../../types/systemDeepDive';
 ...
 * what it is → how it works → what goes wrong → what to do → when to get help.
 *
...
type SectionId = 'overview' | 'how' | 'conditions' | 'prevent' | 'flags';
...
export const SystemDeepDiveView: React.FC<{ data: SystemDeepDive }> = ({ data }) => {
