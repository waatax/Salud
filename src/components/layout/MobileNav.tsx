    ...
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-salud-light-border/80 dark:border-salud-dark-border bg-salud-light-bg/95 dark:bg-salud-dark-bg/95 backdrop-blur-lg px-2 py-1.5 flex items-center justify-around lg:hidden font-mono text-[10px]">
      <button
        ...
        className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg transition-colors ${
          currentChapterId === 'W' ? 'text-salud-cyan font-bold' : 'text-slate-600 dark:text-slate-400'
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg transition-colors ${
          currentChapterId === 'O' ? 'text-salud-amber-600 dark:text-salud-amber font-bold' : 'text-slate-600 dark:text-slate-400'
        }`}
      >
      ...
      <button
        onClick={onOpenGraph}
        className="flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200"
      >
      ...
      <button
        ...
        className="flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-red-500 dark:text-red-400"
      >
